(function() {
    d3.queue()
        ...
        .await(function(error, topoMain, topoKashmir) {
            //topoMain loads from "IND_adm2_Literacy.json"
            //topoKashmir loads from "ne_10m_admin_0_Kashmir_Occupied.json"
